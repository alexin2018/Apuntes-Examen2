...
int main()
{
  ...
  int opcion;
  printf ("ingrese la opcion que desea: 1. cargar autor, 2.cargar libros, 3.listar libros\n");
  scanf(" %d", &opcion);
  switch (opcion) {
        case 1:
            printf("eligio la opcion cargar autor\n");
            cargarAutores( autores, CANT_AUTORES);
            break;
        case 2:
            printf(" eligio la opcion cargar libros\n");
            cargarLibros(libros, autores, CANT_LIBROS);
            break;
        case 3:
            printf("eligio l opcion listar libros\n");
